package com.siderbit.ephemeris.config;
...
//				.apis(RequestHandlerSelectors.any())
				// Para rastrear somente no pacote resouces
				.apis(RequestHandlerSelectors.basePackage("com.siderbit.ephemeris.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Ephemeris",
				"Esta API é utilizada no Trabalho de Conclusão de Curso - equipe: Miguel e Luiz", 
				"Versão 1.0",
				"https://fatecrl.edu.br/cursos/sistemas-para-internet",
//				new Contact("Miguel Arcanjo", "udemy.com/user/nelio-alves", "mig-ramos10@gmail.com"),
				new Contact("Miguel Arcanjo", null, "mig-ramos10@gmail.com"),
