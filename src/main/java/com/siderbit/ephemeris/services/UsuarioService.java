...
public class UsuarioService {
	...
	public Usuario find(Integer id) {
		...
		if (user==null || !user.hasRole(Perfil.ADMIN) || !user.hasRole(Perfil.MEDICO) && !id.equals(user.getId())) {
	...
	public Usuario fromDTO(@Valid UsuarioNewDTO objDto) {
		Usuario usu = new Usuario(null, objDto.getNome(), objDto.getEmail(), objDto.getInstante(), pe.encode(objDto.getSenha()));
